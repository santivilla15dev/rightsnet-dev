...
IMPLEMENT **PASS** (`POST .../report-output` → record + consume auth). Public generation
verify / partner list **not started**. Do not collapse preview vs executable authority.

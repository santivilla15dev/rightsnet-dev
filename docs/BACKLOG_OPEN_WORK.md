...
| Media | ~~Roles DB / RLS~~ | Roles **PASS**; RLS org pilot **PASS**; Campaigns H1–H6 wiring **PASS** (`docs/DB_RLS_CAMPAIGN_WIRING_V0_1.md`, `docs/DB_RLS_CAMPAIGN_H2_H6_WIRING_V0_1.md`); más tablas OPEN |

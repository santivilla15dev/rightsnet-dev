...
**authorize_generation + RN-AUTH + report_output:** PASS (`docs/RN_AUTH_V0_1.md`, `docs/REPORT_OUTPUT_V0_1.md`); public generation verify **not started**
...
3. Public/partner generation verify or list

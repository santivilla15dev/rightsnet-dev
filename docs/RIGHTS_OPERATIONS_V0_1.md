...
**authorize_generation + RN-AUTH:** PASS (`docs/RN_AUTH_V0_1.md`); **`report_output`:** SPECIFY PASS (`docs/REPORT_OUTPUT_V0_1.md`); IMPLEMENT **not started**
...
3. `report_output` IMPLEMENT (`docs/REPORT_OUTPUT_V0_1.md`)
